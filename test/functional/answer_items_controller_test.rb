...
class AnswerItemsControllerTest < ActionController::TestCase
  ...
  test "should create answer_item" do
    assert_difference('AnswerItem.count') do
      post :create, answer_item: { choice_id: @answer_item.choice_id, question_id: @answer_item.question_id, wx_id: @answer_item.wx_id }
    end
  ...
  test "should update answer_item" do
    put :update, id: @answer_item, answer_item: { choice_id: @answer_item.choice_id, question_id: @answer_item.question_id, wx_id: @answer_item.wx_id }
    assert_redirected_to answer_item_path(assigns(:answer_item))
  end
